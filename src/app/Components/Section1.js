  ...
  return (
    <>
      <div className="relative max-w-full h-screen ">
        <div className="bg-purple-600 h-4/5 w-4/5 bottom-14 rounded-r-3xl absolute z-1"></div>

        <div className="absolute w-4/5 z-10 right-0 top-4 max-xl:pr-0 max-sm:w-5/6 ">
          <Image
        ...
        <div className="absolute w-[58%] z-[11] bg-white bottom-0 left-12  border border-gray-300 p-10 rounded-xl max-sm:w-full max-sm:p-5">
          <strong className="text-5xl max-md:text-4xl">
            We elevate top wedding pros
          </strong>{" "}
          <br />
          <strong className="text-5xl max-md:text-4xl">(just like you!)</strong>
          <p className="mt-6 mr-2 text-lg max-md:text-base">
